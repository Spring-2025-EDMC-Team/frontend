  ...
  return (
    <Container>
      <Typography variant="h4" sx={{ my: 4 }}>
        Assign Organizer Awards to Teams
      </Typography>
              ...
              >
                <Box>
                  ...
                  <Typography variant="body2">
                    Type: {award.isJudge ? "Judge assigned" : "Organizer assigned"}, Assigned to Team:{" "}
